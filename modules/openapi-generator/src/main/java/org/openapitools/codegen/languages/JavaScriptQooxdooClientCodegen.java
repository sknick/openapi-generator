...
public class JavaScriptQooxdooClientCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    public JavaScriptQooxdooClientCodegen() {
        super();

        modifyFeatureSet(features -> features.includeDocumentationFeatures(DocumentationFeature.Readme));

        outputFolder = "generated-code/js-qooxdoo";
...
//        apiTestTemplateFiles.put("api_test.mustache", ".js");
        ...
        embeddedTemplateDir = templateDir = "JavaScript-Qooxdoo";
        apiPackage = "api";
        modelPackage = "model";
...
//        apiDocTemplateFiles.put("api_doc.mustache", ".md");
    ...
    public String getName() {
        return "javascript-qooxdoo";
    }

    @Override
    public String getHelp() {
        return "Generates a JavaScript Qooxdoo client library.";
    }
    ...
    public CodegenModel fromModel(String name, Schema model) {
        ...
        if (allDefinitions != null && codegenModel != null && codegenModel.parent != null && codegenModel.hasEnums) {
            ...
            if (parentModel != null) {
                ...
                codegenModel = JavaScriptQooxdooClientCodegen.reconcileInlineEnums(codegenModel, parentCodegenModel);
            }
        }
